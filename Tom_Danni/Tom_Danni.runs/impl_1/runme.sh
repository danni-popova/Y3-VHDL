...
HD_PWD='N:/VHDL/Tom_Danni/Tom_Danni.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Danni.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Danni.tcl -notrace
