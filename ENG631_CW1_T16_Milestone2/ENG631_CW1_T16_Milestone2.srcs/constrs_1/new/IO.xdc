...
set_property IOSTANDARD LVCMOS33 [get_ports {inSwitches[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {inSwitches[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {inSwitches[0]}]
