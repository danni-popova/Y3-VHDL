...
set_property used_in_implementation false [get_files N:/GitHub/Y3-VHDL/ENG631_CW1_T16_Milestone2/ENG631_CW1_T16_Milestone2.srcs/constrs_1/new/IO.xdc]

set_param ips.enableIPCacheLiteLoad 0
close [open __synthesis_is_running__ w]

synth_design -top TopComponent -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef TopComponent.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file TopComponent_utilization_synth.rpt -pb TopComponent_utilization_synth.pb"
